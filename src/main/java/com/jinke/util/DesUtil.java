...
public class DesUtil {
    ...
    public static String getEncry(String data) {
    ...
    public static String getText(String data) {
        ...
        byte[] by = new byte[s1.length];
        for (int i = 0; i < s1.length; i++) {
            by[i] = Byte.parseByte(s1[i]);
        }
        DesUtil desUtil = new DesUtil();
        String result = new String(desUtil.DesEncrypt(by, 0));
        return result;
    }
